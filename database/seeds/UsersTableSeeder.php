        ...
        DB::table('users')->insert(
            [
                [
                    ...
                    'verify_token' => base64_encode('admin@gmail.com') . '.' . base64_encode(now()),
                    'verify_at'    => now(),
                ],
                [
                    ...
                    'verify_token' => base64_encode('ongvanphat124@gmail.com') . '.' . base64_encode(now()),
                    'verify_at'    => now(),
                ],
                [
                    ...
                    'verify_token' => base64_encode('nguyenminhnhatdn91@gmail.com') . '.' . base64_encode(now()),
                    'verify_at'    => now(),
                ],
            ]
        );
